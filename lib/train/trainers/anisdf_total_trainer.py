...
class NetworkWrapper(nn.Module):
    def __init__(self, net):
        ...
        if cfg.train_part == 'body' or cfg.train_part == 'combine':
    ...
    def forward(self, batch):
        ...
        if batch['latent_index'].item() < cfg.num_trained_mask and 'msk_sdf' in ret and ret['msk_sdf'].shape[1] > 0 and not cfg.train_bgfg and cfg.train_part != 'combine' and cfg.train_with_mask:
            # 不对脸的图像处理，否则会出现凹痕
