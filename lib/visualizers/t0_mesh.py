...
class Visualizer:
    ...
    def visualize(self, output, batch):
        ...
        if cfg.debug.train_mesh:
            result_dir = 'data/animation/{}_train_mesh'.format(cfg.exp_name)
        else:
            result_dir = 'data/animation/{}'.format(cfg.exp_name)
        ...
        vis3d = Vis3D(out_folder=os.path.join(result_dir, 'vis3d'), sequence_name='toy')
        vis3d.add_mesh(mesh, name='tpose')
